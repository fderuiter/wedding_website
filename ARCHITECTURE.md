...
| `venueTimezone` | `default` | Configuration field for venueTimezone |
| `startTime` | `default` | Configuration field for startTime |
| `endTime` | `default` | Configuration field for endTime |
