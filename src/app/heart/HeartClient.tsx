 ...
 */
function Heart3D({ scale, primaryColor, secondaryColor, name1, name2 }: { scale: number; primaryColor: string; secondaryColor: string; name1: string; name2: string }) {
  const geom = useMemo(() => {
    ...
    <>
      ...
      >
        ...
        <group ref={groupRef} {...bind()} visible={!isBroken}>
          <Heart3D scale={scale} primaryColor={primaryColor} secondaryColor={secondaryColor} name1={name1} name2={name2} />
        </group>
      </RigidBody>

      <RigidBody ref={brokenHeartLeftRef} colliders="hull" restitution={0.9} type={'fixed'}>
        <group visible={isBroken}>
          <Heart3D scale={scale * 0.7} primaryColor={primaryColor} secondaryColor={secondaryColor} name1={name1} name2={name2} />
        </group>
      </RigidBody>
 ...
 */
export default function HeartClient({ name1, name2 }: { name1: string; name2: string }) {
