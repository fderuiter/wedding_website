...
/**
 * @component ProjectInfoClient
 * @description The client-side component for the Project Info page.
 * It contains all the interactive elements and animations using Framer Motion.
 *
 * @returns {JSX.Element} The rendered project info client component.
 */
const ProjectInfoClient = () => {
  return (
