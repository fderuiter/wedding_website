...
const ProjectInfo = () => {
  return (
    <div className="min-h-screen bg-[var(--color-background)] text-[var(--color-foreground)] selection:bg-primary-100 selection:text-primary-900 dark:selection:bg-primary-800 pb-24">
      {/* Hero Section */}
      <motion.div
      ...
      >
        <h1 className="text-5xl font-extrabold mb-4 bg-gradient-to-r from-primary-700 to-amber-500 text-transparent bg-clip-text">About This Project</h1>
        ...
        <a
          ...
          className="inline-flex items-center gap-2 px-6 py-2 rounded-full bg-gradient-to-r from-primary-700 to-amber-500 text-white font-semibold shadow-lg hover:scale-105 transition-transform"
        >
      ...
      <motion.div
        ...
        custom={1}
      >
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-10 flex flex-col items-center border border-primary-100 dark:border-gray-700">
          <h2 className="text-2xl font-bold mb-6 text-primary-700 tracking-tight">Key Features</h2>
      ...
      >
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-10 border border-gray-200 dark:border-gray-700">
          <h2 className="text-2xl font-bold mb-4 text-primary-700 tracking-tight">Architecture Overview</h2>
      ...
      <div className="max-w-4xl mx-auto mt-12 px-4 grid md:grid-cols-2 gap-8">
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 flex flex-col border border-gray-200 dark:border-gray-700">
          <h2 className="text-xl font-bold mb-3 text-primary-700">Deployment</h2>
          <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2">
            <li>Deploy to <a href='https://vercel.com/' className='underline text-primary-600 dark:text-primary-400 hover:text-primary-800 dark:hover:text-primary-300' target='_blank' rel='noopener noreferrer'>Vercel</a> or <a href='https://www.netlify.com/' className='underline text-primary-600 dark:text-primary-400 hover:text-primary-800 dark:hover:text-primary-300' target='_blank' rel='noopener noreferrer'>Netlify</a>.</li>
            ...
            <li>See <a href='https://github.com/fderuiter/wedding_website#readme' className='underline text-primary-600 dark:text-primary-400 hover:text-primary-800 dark:hover:text-primary-300' target='_blank' rel='noopener noreferrer'>README</a> for full setup instructions.</li>
          </ul>
        </div>
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 flex flex-col border border-gray-200 dark:border-gray-700">
          ...
          <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2">
            ...
            <li>See <a href='https://github.com/fderuiter/wedding_website' className='underline text-primary-600 dark:text-primary-400 hover:text-primary-800 dark:hover:text-primary-300' target='_blank' rel='noopener noreferrer'>CONTRIBUTING.md</a> for guidelines.</li>
      ...
      <div className="text-center text-gray-500 dark:text-gray-400 mt-16 text-sm">
        Made with <span className="text-primary-500">♥</span> &bull; Open Source on <a className="underline text-primary-600 dark:text-primary-400 hover:text-primary-800 dark:hover:text-primary-300" href="https://github.com/fderuiter/wedding_website" target="_blank" rel="noopener noreferrer">GitHub</a>
      </div>
    </div>
  );
};
