...
const ProjectInfo = () => {
  return (
    <div className="min-h-screen bg-[var(--color-background)] text-[var(--color-foreground)] selection:bg-primary selection:text-primary dark:selection:bg-primary pb-24">
      {/* Hero Section */}
      <motion.div
