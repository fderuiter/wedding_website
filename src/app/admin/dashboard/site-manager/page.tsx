...
export default function SiteManagerPage() {
  ...
  if (loading) return <div className="p-8 text-center text-primary-700">Loading Site Manager...</div>;
    ...
    <main className="min-h-screen bg-[var(--color-background)] text-[var(--color-foreground)] py-10 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-4xl font-extrabold text-primary-700 tracking-tight">Visual Site Manager</h1>
        ...
        <div className="space-y-4">
          {features.map((feature, index) => (
            <div 
              ...
              className={`p-4 rounded-xl shadow border border-primary-100 dark:border-primary-800 flex justify-between items-center cursor-move transition ${!feature.visible ? 'opacity-50 bg-gray-50 dark:bg-gray-900' : 'bg-white dark:bg-gray-800'}`}
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-bold text-xl text-primary-700">{feature.title || feature.id}</h3>
        ...
        {showCustomModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
            <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-xl max-w-lg w-full">
              <h2 className="text-2xl font-bold mb-4 text-primary-700">Add Custom Section</h2>
              <div className="space-y-4">
                <div>
