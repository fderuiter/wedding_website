    ...
    >
      <div className="py-10 px-4 sm:px-6 max-w-5xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-3xl font-extrabold text-primary-700">Attractions Studio</h1>
          <div>
            ...
            <button onClick={() => { 
              ...
              setIsEditing(true); 
            }} className="px-4 py-2 bg-primary-600 text-white rounded hover:bg-primary-700 transition">Add New Attraction</button>
          </div>
        </div>
        ...
        <div className="grid gap-4 pb-10">
          {attractions.map(attraction => (
            <div key={attraction.id} className={`bg-white dark:bg-gray-800 p-4 rounded-xl shadow border border-primary-100 flex justify-between items-center ${!attraction.isVisible ? 'opacity-50' : ''}`}>
              ...
              <div className="space-x-2 flex flex-col gap-2">
                ...
                <button onClick={() => handleDelete(attraction.id)} className="bg-primary-600 text-white px-3 py-1 rounded text-sm">Delete</button>
              </div>
            </div>
          ))}
