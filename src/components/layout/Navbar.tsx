            ...
            <nav className="ml-10 flex items-baseline space-x-4">
              {allLinks.map((link) => (
                <Link
                  ...
                  className={`px-3 py-2 rounded-md text-sm font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 ${
                    pathname === link.href
            ...
            {isAdmin && (
              <div className="ml-4 flex items-center md:ml-6">
                ...
                <button
                  ...
                  className="ml-4 bg-primary-600 hover:bg-primary-700 text-white text-xs py-1 px-3 rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2"
                >
                  Logout
                </button>
              </div>
          ...
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            {allLinks.map((link) => (
              <Link
                ...
                aria-current={pathname === link.href ? "page" : undefined}
                className={`block px-3 py-2 rounded-md text-base font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 ${
                  pathname === link.href
                    ? 'text-white bg-primary-500'
                    : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'
                }`}
              ...
              <div className="pt-4 pb-3 border-t border-gray-700">
                ...
                <div className="mt-3 px-2 space-y-1">
                  <button
                    ...
                    className="block w-full text-left px-3 py-2 rounded-md text-base font-medium text-gray-400 hover:text-white hover:bg-gray-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2"
                  >
                    Logout
                  </button>
                </div>
