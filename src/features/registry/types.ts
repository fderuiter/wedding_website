...
export interface IRegistryRepository {
  ...
  createItem(data: Omit<RegistryItemDTO, 'id' | 'contributors' | 'createdAt' | 'updatedAt' | 'amountContributed' | 'purchased'>): Promise<RegistryItemDTO>;
  updateItem(id: string, data: Partial<RegistryItemDTO>): Promise<RegistryItemDTO>;
