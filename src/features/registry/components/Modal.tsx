  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-60 z-50 p-4" role="dialog" aria-modal="true" ref={modalRef}>
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-xl w-full p-6 relative max-h-[90vh] overflow-y-auto text-gray-800 dark:text-gray-100">
        <button
          className="absolute top-3 right-3 text-gray-500 hover:text-primary-600 dark:hover:text-primary-400 rounded-full p-1 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2"
          onClick={onClose}
        ...
        <h2 className="text-2xl font-bold mb-2 text-primary-700">{item.name}</h2>
        ...
        {isVendorUrlSafe && (
          <a
            ...
            className="inline-block text-primary-600 dark:text-primary-400 hover:text-primary-800 dark:hover:text-primary-300 underline mb-4 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 rounded"
          >
            View on Vendor Site
          </a>
        )}
        {!item.purchased ? (
          <div className="mt-5 pt-4 border-t border-primary-100">
            ...
            <div className="mb-3">
              ...
              <input
                ...
                className="border border-gray-300 dark:border-gray-600 p-2 rounded w-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 outline-none bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-100"
            ...
            <button
              className={`w-full bg-gradient-to-r from-primary-700 to-amber-500 text-white font-bold px-4 py-2 rounded shadow hover:from-amber-500 hover:to-primary-700 transition flex items-center justify-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-primary-500 ${isSubmitting ? 'opacity-75 cursor-not-allowed' : ''}`}
          ...
          <div className="mt-5 pt-4 border-t border-primary-100 text-center">
