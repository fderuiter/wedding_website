...
export default function RegistryPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--color-background)] text-[var(--color-foreground)] selection:bg-primary-100 selection:text-primary-900 dark:selection:bg-primary-800 pb-32 px-2 sm:px-4">
      <motion.h1
        className="text-5xl font-extrabold text-center mb-12 pt-12 text-primary-700 tracking-tight drop-shadow-lg"
      ...
      <nav
        className="sticky top-0 z-30 bg-white/90 dark:bg-gray-800/90 backdrop-blur border-b border-primary-100 dark:border-gray-700 max-w-4xl mx-auto px-2 sm:px-6 mb-10 flex flex-col gap-4 py-4 rounded-xl shadow-md"
        ...
        <div className="flex flex-wrap justify-center items-center gap-4 mt-4">
          <div className="flex items-center">
            <input
              ...
              className="h-4 w-4 text-primary-600 border-gray-300 rounded focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:outline-none focus-visible:ring-offset-2"
            />
          ...
          >
            <div className="absolute top-4 right-4 z-50">
              <button
                ...
                className="bg-white dark:bg-gray-800 rounded-full p-2 shadow-lg border border-gray-200 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-primary-400"
